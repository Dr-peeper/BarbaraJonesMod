...
import com.barbarajones.v2.mobs.entity.ai.CravelingCrumbleAttackGoal;
...
/**
 * CRAVELING - the baseline of the mod's new overworld hostile family: a
 ...
 * {@link CravelingCrumbleAttackGoal} sprays crumbs and can gum up a target's
 ...
 */
public class CravelingEntity extends Monster implements CravelingKin {

    public CravelingEntity(EntityType<? extends CravelingEntity> type, Level level) {
        super(type, level);
        this.xpReward = 5;
    }
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new CravelingCrumbleAttackGoal(this, 1.0D, false));
    ...
    public void aiStep() {
        ...
        // while actually moving on the ground, so a standing Craveling isn't
        // constantly shedding.
    ...
    protected SoundEvent getAmbientSound() {
        return ModMobSounds.CRAVELING_AMBIENT.get();
    }

    @Override
    protected SoundEvent getHurtSound(DamageSource source) {
        return ModMobSounds.CRAVELING_HURT.get();
    }

    @Override
    protected SoundEvent getDeathSound() {
        return ModMobSounds.CRAVELING_DEATH.get();
    }
}
