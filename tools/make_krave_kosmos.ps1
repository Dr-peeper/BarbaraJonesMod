...
# ---- Krave Block ("Chocolate Block"): the portal frame ----------------------
# krave_block.png is no longer drawn here - it's vanilla stone_bricks.png,
# recolored, generated by tools/make_krave_terrain_textures.ps1. This
# script still owns its blockstate/model (unrelated to which tool paints
# the PNG) - same split as krave_dirt/krave_grass_top/krave_grass_side.
...
"  krave_block: blockstate + models (texture generated separately)"
...
# krave_dirt.png / krave_grass_top.png / krave_grass_side.png are no longer
# drawn here - they're vanilla's own dirt/grass art, recolored, generated by
# tools/make_krave_terrain_textures.ps1. This script still owns their
# blockstates/models below (unrelated to which tool paints the PNGs).
